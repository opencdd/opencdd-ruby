...
class Opencdd::Cddal::GeneratedParser
...
rule
  ...
  document
    : /* empty */                    { result = Opencdd::Cddal::AST::Document.new(declarations: []) }
  ...
  import_item
    : IDENT                             { result = Opencdd::Cddal::AST::ImportedName.new(name: val[0]) }
    | IDENT soft_as IDENT               { result = Opencdd::Cddal::AST::ImportedName.new(name: val[0], as: val[2]) }
    ;
  ...
  value
    : STRING                         { result = Opencdd::Cddal::AST::Literal.new(kind: :string, raw: val[0]) }
    | NUMBER                         { result = Opencdd::Cddal::AST::Literal.new(kind: :number, raw: val[0]) }
    | DATE                           { result = Opencdd::Cddal::AST::Literal.new(kind: :date, raw: val[0]) }
    | TRUE                           { result = Opencdd::Cddal::AST::Literal.new(kind: :boolean, raw: "true") }
    | FALSE                          { result = Opencdd::Cddal::AST::Literal.new(kind: :boolean, raw: "false") }
    | NULL                           { result = Opencdd::Cddal::AST::Literal.new(kind: :null, raw: "null") }
    | IRDI                           { result = Opencdd::Cddal::AST::IdentifierRef.new(name: val[0]) }
    | condition
    | class_reference
    | dotted_ref
    | set
    | tuple
    | IDENT                          { result = Opencdd::Cddal::AST::IdentifierRef.new(name: val[0]) }
    ;
  ...
  set
    : LBRACE RBRACE                  { result = Opencdd::Cddal::AST::Set.new(elements: []) }
    | LBRACE set_element_list RBRACE { result = Opencdd::Cddal::AST::Set.new(elements: val[1]) }
    ;
